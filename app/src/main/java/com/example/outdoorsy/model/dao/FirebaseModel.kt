...
//                userViewModel.user.value = user // Update UserViewModel's user LiveData
//            }
//            .addOnFailureListener { exception ->
//                userViewModel.user.value = null // Handle error
//            }
//
//        // No need to wait or return anything here
//        return null // or you can return userViewModel.user.value
//    }
    suspend fun getUser(userId: String): UserModel? {
        return try {
            val documentSnapshot = usersCollection.document(userId).get().await()
